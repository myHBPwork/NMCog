...
class NEAL3Way(object):
    ...
    * Refer to :py:mod:`nmcog.specialfunction.neal.FSAHelperFunctions.getConnectors` for details on how the `neuron populations <http://neuralensemble.org/docs/PyNN/reference/populations.html>`_ within a cell assembly are connected.
